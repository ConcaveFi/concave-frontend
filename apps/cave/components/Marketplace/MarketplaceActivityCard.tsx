...
<Card
    ...
    <Box mx="auto" py={5} w="90px" h="37px" shadow="down" borderRadius="16px">
        <Text fontSize="s" color="white" fontWeight="bold">All</Text>
    </Box> 
    <Box mx="auto" py={5} w="90px" h="37px" shadow="down" borderRadius="16px">
    <Text fontSize="s" color="white" fontWeight="bold">Listing</Text>
    </Box>
    <Box mx="auto" py={5} w="90px" h="37px" shadow="down" borderRadius="16px">
    <Text fontSize="s" color="white" fontWeight="bold">Sale</Text>
    </Box>
    </Flex>

    <Flex>
    <Box mx="auto" py={5} w="250px" h="100px" shadow="up" borderRadius="16px">
    </Box>   
    </Flex>
        </Card>
        </div>
