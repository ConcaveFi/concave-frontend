...
import { ApproveButton } from 'hooks/useAllowance'
...
const SupplyLiquidityContent = ({
  ...
  return (
    <>
      ...
      <ApproveButton size="large" w="full" variant={'primary'} useApproveInfo={lpData.approval0} />
      <ApproveButton size="large" w="full" variant={'primary'} useApproveInfo={lpData.approval1} />
      {!lpData.needsApprove0 && !lpData.needsApprove1 && (
