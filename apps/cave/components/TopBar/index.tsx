import { HStack, Flex, Heading, Image, Center, Card } from '@concave/ui'
      ...
      >
        <Flex justifyContent="space-between" maxHeight="72px">
          <HStack spacing="0" my={-3} overflow="hidden" pr={1}>
            ...
            <Logo />
            <TopBarNavItem href="/liquidstaking" isActive={route === 'liquidstaking'}>
              Liquid Staking
            </TopBarNavItem>
            ...
            <TopBarNavItem href="/marketplace" isActive={route === 'marketplace'}>
              Liquid Staking
            </TopBarNavItem>
          </HStack>
