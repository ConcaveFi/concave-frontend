...
export const TreasuryInfo = ({ box1, box2, box3 }) => {
  return (
    <Card variant='secondary' bg="none" py={3} w="599px" h="100px" direction="row" shadow="Glass Up Medium">
      <Flex justify="center" flexBasis="40%">
        <TreasuryInfoItem value="Market Cap" label="Asset" />
      </Flex>
      <Box w="1px" mx={0} my={-4} borderRight="2px solid white"/>
      <TreasuryInfoItem  value="CNV Price" label="ROI" flexGrow={1} pl={3} pr={3} flexBasis="25%" />
      <Box w="1px" mx={0} my={-4} borderRight="2px solid white" />
      <TreasuryInfoItem value="Treasury value per CNV" label="Vesting Term" px={5} flexBasis="35%" />
    </Card>
  )
}
