...
export type CoinType = {
  coingecko: string
  name: string
  symbol: AvaliableCoins
  decimals: number
  logoURI: string
  [chainId: number]: string
}
export const coins = { aCNV, USDT, bbtCNV, FRAX, DAI, LINK } as const
export type AvaliableCoins = keyof typeof coins
