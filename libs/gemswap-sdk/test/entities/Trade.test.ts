...
describe('Trade', () => {
  ...
  describe('#bestTradeExactIn', () => {
    it('throws with empty pairs', () => {
      expect(() =>
        Trade.bestTradeExactIn([], CurrencyAmount.fromRawAmount(token0, JSBI.BigInt(100)), token2),
      ).toThrow('PAIRS')
    })
  ...
  describe('#maximumAmountIn', () => {
    describe('tradeType = EXACT_INPUT', () => {
      ...
      it('throws if less than 0', () => {
        expect(() =>
          exactIn.maximumAmountIn(new Percent(JSBI.BigInt(-1), JSBI.BigInt(100))),
    ...
    describe('tradeType = EXACT_OUTPUT', () => {
      ...
      it('throws if less than 0', () => {
        expect(() =>
          exactOut.maximumAmountIn(new Percent(JSBI.BigInt(-1), JSBI.BigInt(100))),
        ).toThrow('SLIPPAGE_TOLERANCE')
      })
      it('returns exact if 0', () => {
  ...
  describe('#minimumAmountOut', () => {
    describe('tradeType = EXACT_INPUT', () => {
      ...
      it('throws if less than 0', () => {
        expect(() =>
          exactIn.minimumAmountOut(new Percent(JSBI.BigInt(-1), JSBI.BigInt(100))),
        ).toThrow('SLIPPAGE_TOLERANCE')
      })
      it('returns exact if 0', () => {
    ...
    describe('tradeType = EXACT_OUTPUT', () => {
      ...
      it('throws if less than 0', () => {
        expect(() =>
          exactOut.minimumAmountOut(new Percent(JSBI.BigInt(-1), JSBI.BigInt(100))),
        ).toThrow('SLIPPAGE_TOLERANCE')
      })
      it('returns exact if 0', () => {
  ...
  describe('#worstExecutionPrice', () => {
    ...
    describe('tradeType = EXACT_OUTPUT', () => {
      ...
      it('throws if less than 0', () => {
        expect(() => exactOut.worstExecutionPrice(new Percent(-1, 100))).toThrow(
          'SLIPPAGE_TOLERANCE',
        )
      })
      it('returns exact if 0', () => {
