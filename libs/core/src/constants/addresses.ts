...
export const MARKETPLACE_CONTRACT: AddressMap = {
  ...
  [ChainId.GÖRLI]: '0xf6E2523cf1f87bfa8f97eB81f8445329F174e216',
}

export const STAKING_CONTRACT: AddressMap = {
  [ChainId.LOCALHOST]: '0x93c3A816242E50Ea8871A29BF62cC3df58787FBD',
  [ChainId.ETHEREUM]: '0x93c3A816242E50Ea8871A29BF62cC3df58787FBD',
  [ChainId.RINKEBY]: '0xB9E431Fc34152246BB28453b6ce117829E8A5B0C',
  [ChainId.GÖRLI]: '0x18802e141a28ce2553b566b33e4c9fb997bd2c95',
}
export const BOND_ADDRESS: AddressMap = {
  [ChainId.LOCALHOST]: '0xe42bce7bd1a94f99a099ee9242Aa0f3B2F5b1D50',
  ...
  [ChainId.GÖRLI]: '0x0a69E01ddE27cd6ddf2Ba215Cd60d1F0a8c150c1',
}
...
export const AIRDROP_CLAIM: AddressMap = {
  [ChainId.LOCALHOST]: '0x8b8be4848934812d6e24af1ae9aad01d3c0ef3fd',
...
export const AIRDROP_CLAIM_Q4: AddressMap = {
  ...
  [ChainId.ETHEREUM]: '0x55499012EF1E05952A54C6ba642e3148Afd43FF2',
  [ChainId.SEPOLIA]: '0xad70174380700c91e95fd8f19affeb3a0854189e',
}

export const BBTCNV_ADDRESS: AddressMap = {
  [ChainId.LOCALHOST]: '0x0000000012a0592C154D552C410030E724b2eA00',
...
export const BBTCNV_REDEMPTION_V2: AddressMap = {
  [ChainId.LOCALHOST]: '0xc3CBd1e850D431adC583f14f03b9B8B651e62A61',
...
export const PCNV_ADDRESS: AddressMap = {
  [ChainId.LOCALHOST]: '0xCfF79e48a2dc2f213F23d03b2BFFBbc541CeEF22',
  [ChainId.ETHEREUM]: '0xCfF79e48a2dc2f213F23d03b2BFFBbc541CeEF22',
  [ChainId.RINKEBY]: '0xC82cC6a1f946D20ea88Fe9C04A1b258cA6F25E98',
  [ChainId.GÖRLI]: '0xC82cC6a1f946D20ea88Fe9C04A1b258cA6F25E98', //new address?!
}
...
export const FACTORY_ADDRESS: AddressMap = {
  [ChainId.LOCALHOST]: '0x066a5cb7ddc6d55384e2f6ca13d5dd2cd2685cbd',
  ...
  [ChainId.GÖRLI]: '0x5626b74CB4C39AfdfD9aB706cE1CDc4001d70B07',
}
...
export const ROUTER_ADDRESS: AddressMap = {
  [ChainId.LOCALHOST]: '0x0a3e1c20b5384eb97d2ccff9a96bc91f0c77e7db',
  ...
  [ChainId.GÖRLI]: '0xef2eea0113f37ff6d7fdf8fd26482d90bbb219bc',
}

export const CNV_ADDRESS: AddressMap = {
  [ChainId.LOCALHOST]: '0x000000007a58f5f58E697e51Ab0357BC9e260A04',
  ...
  [ChainId.GÖRLI]: '0xC559F8E9b878cE1c91aEE96A2B7e4142eEF2d2aA',
}

export const FRAX_ADDRESS: AddressMap = {
  [ChainId.LOCALHOST]: '0x853d955aCEf822Db058eb8505911ED77F175b99e',
...
export const DAI_ADDRESS: AddressMap = {
  [ChainId.LOCALHOST]: '0x6B175474E89094C44Da98b954EedeAC495271d0F',
  [ChainId.ETHEREUM]: '0x6B175474E89094C44Da98b954EedeAC495271d0F',
  [ChainId.GÖRLI]: '0xdc31Ee1784292379Fbb2964b3B9C4124D8F89C60',
...
export const WNATIVE_ADDRESS: AddressMap = {
  [ChainId.LOCALHOST]: WETH9_ADDRESS[ChainId.ETHEREUM],
...
export const USDT_ADDRESS: AddressMap = {
  [ChainId.LOCALHOST]: '0xdAC17F958D2ee523a2206206994597C13D831ec7',
