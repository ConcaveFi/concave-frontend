export const PCNV_REDEMPTION_ABI = [
  {
    inputs: [{ internalType: 'address', name: '_CNV', type: 'address' }],
  ...
  {
    anonymous: false,
    inputs: [{ indexed: true, internalType: 'bool', name: '_paused', type: 'bool' }],
    name: 'Paused',
    type: 'event',
  },
  {
  ...
  {
    inputs: [],
    name: 'LINEAR_VESTING_TIME_LENGTH',
  ...
  {
    inputs: [],
    name: 'LINEAR_VESTING_TIME_START',
    outputs: [{ internalType: 'uint256', name: '', type: 'uint256' }],
    stateMutability: 'view',
    type: 'function',
  },
