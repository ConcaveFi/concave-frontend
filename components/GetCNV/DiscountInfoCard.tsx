    ...
    <InfoCard>
      ...
      <HStack h="120px" divider={<Box w="1px" h="100%" bg="strokeReflection" />}>
        <VStack w="100%" spacing="2px">
          <Text color="text.3" fontSize="s" fontWeight="bold">
            Current Price
          </Text>
          <Text color="text.2" fontSize="xl" fontWeight="bold">
            $3,312.31
          </Text>
        </VStack>
        <VStack w="100%" spacing="2px">
          <Text color="text.3" fontSize="s" fontWeight="bold" spacing="5px">
            Discount
          </Text>
          <Text color="text.2" fontSize="3xl" fontWeight="bold">
            9.31%
          </Text>
        </VStack>
        <VStack w="100%" spacing="2px">
